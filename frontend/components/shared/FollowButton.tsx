  ...
  return (
    <button
      ...
      className={`flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-bold transition-all cursor-pointer shrink-0 ${
        isFollowing
          ? "bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-red-50 hover:text-red-600 border border-slate-200 dark:border-slate-700 dark:hover:bg-red-900/20 dark:hover:border-red-900/30"
          : "text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-800 hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-500 dark:hover:border-indigo-500"
      } ${isLoading ? "opacity-70 cursor-not-allowed" : ""}`}
