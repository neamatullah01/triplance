            ...
            <tbody>
              {filtered.map((booking) => (
                ...
                >
                  ...
                  <td className="px-6 py-3.5 font-medium text-slate-900 dark:text-white">{booking.traveler}</td>
                  <td className="px-6 py-3.5 text-slate-600 dark:text-slate-300">{booking.package}</td>
                  <td className="px-6 py-3.5 text-slate-500 dark:text-slate-400">{booking.agency}</td>
                  <td className="px-6 py-3.5"><StatusBadge status={booking.status} /></td>
                  <td className="px-6 py-3.5 text-slate-700 dark:text-slate-300">{booking.travelers}</td>
                  <td className="px-6 py-3.5 text-slate-500 dark:text-slate-400">{booking.date}</td>
                  <td className="px-6 py-3.5 text-right font-semibold text-slate-900 dark:text-white">{booking.amount}</td>
